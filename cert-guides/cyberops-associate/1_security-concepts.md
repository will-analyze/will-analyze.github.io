...
This are the notes I made while following along Cisco's CyberOps guide for Topic 1.0: **Security Concepts**, along with other sources (links posted with notes). 

If you have any suggestions/changes feel free to propose them via a commit
